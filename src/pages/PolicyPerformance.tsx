...
const KPIS = [
  { label: 'Policies in Force', value: '4.2M',  sub: 'Active Policies', color: '#4ADE80' },
  { label: 'Retention Rate',    value: '94.1%', sub: 'This Year',        color: '#4ADE80' },
  { label: 'Lapse Rate',        value: '3.2%',  sub: 'This Quarter',     color: '#4ADE80' },
  { label: 'NPS Score',         value: '67',    sub: 'Current Period',   color: '#4ADE80' },
]
  ...
  return (
    <div className="embed-page">
      <div className="page-header">
        <h1>Policy Performance</h1>
        <p>Retention rates, lapse analysis, NPS by product, and portfolio risk concentration</p>
      </div>
      <PageKpis />
